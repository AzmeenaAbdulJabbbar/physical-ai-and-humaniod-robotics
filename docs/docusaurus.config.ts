...
const config: Config = {
  ...
  url: 'https://azmeenaabduljabbbar.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/physical-ai-and-humaniod-robotics/',

  // GitHub pages deployment config.
  organizationName: 'AzmeenaAbdulJabbbar', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/AzmeenaAbdulJabbbar/physical-ai-and-humaniod-robotics/tree/main/docs/',
        },
        blog: false, // Blog section completely disabled
        theme: {
